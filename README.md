...
> **Cuidado com data leakage:** todas as features de histórico usam `.shift(1)` para garantir que o modelo nunca vê informações do próprio jogo que está prevendo.
